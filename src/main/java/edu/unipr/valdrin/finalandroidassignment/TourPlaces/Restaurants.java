    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Location to Princessa Gresa Restaurant Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to El Greco Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to Liburnia Restaurant Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to HOME Restaurant & Lounge Bar Pristina",Toast.LENGTH_LONG).show();
            }
        });
    }
}