    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Location to New Born Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to Gorenje Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to  Albi Mall Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to The Mall Pristina",Toast.LENGTH_LONG).show();
            }
        });
    }
}