    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),"Location to ICT Metting Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to Book Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to  Hackathon Pristina",Toast.LENGTH_LONG).show();
            }
        });
        ...
        image4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(getApplicationContext(),"Location to Kosovo Youth Pristina",Toast.LENGTH_LONG).show();
            }
        });
    }
